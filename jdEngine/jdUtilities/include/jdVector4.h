...
///////////////////////////////////////////////////////////////////////////////
	 ...
	 FORCEINLINE JDVector4& JDVector4::operator/=(const float& scale)
	 {
	 	x /= scale; y /= scale; z /= scale; w /= scale;
	 	return *this;
	 }
	 
		FORCEINLINE JDVector4& JDVector4::operator/=(const JDVector4& vec)
	 {
	 		x /= vec.x; y /= vec.y; z /= vec.z; w /= vec.w;
	 		return *this;
	 }
	 ...
	 FORCEINLINE float 
		JDVector4::operator[](int32 index) const {
	 	 return (&x)[index];
	 }
	 
	 FORCEINLINE float& 
		JDVector4::operator[](int32 index) {
	  	return (&x)[index];
	 }
