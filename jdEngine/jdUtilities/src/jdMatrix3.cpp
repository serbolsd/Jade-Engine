...
namespace jdEngineSDK {
		...
		JDMatrix3::JDMatrix3(float m0, float m1, float m2, float m3, float m4, 
		...
		JDMatrix3::JDMatrix3(const JDVector3& m012, const JDVector3& m345, 
	 ...
	 JDMatrix3& 
		...
		float 
		JDMatrix3::operator[](int index) const	{
				return m[index];
		}

		float& 
		JDMatrix3::operator[](int index)	{
				return m[index];
		}

		JDMatrix3 
		operator-(const JDMatrix3& mat)	{
				return JDMatrix3	(-mat.m[0], -mat.m[1], -mat.m[2], -mat.m[3], -mat.m[4], 
